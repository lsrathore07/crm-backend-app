...
const {createTicket, deleteTicket,geAllTickets, getTicketById, updateTicketById} = require("../Controllers/ticketController")
...
module.exports = (app)=>{
    ...
    app.delete("/crm/api/v1/tickets/:id", deleteTicket)
